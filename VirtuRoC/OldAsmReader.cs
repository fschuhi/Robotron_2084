...
namespace Robotron {
    ...
    class OldAsmLine {
        ...
        public OldAsmLine( int lineno, string[] fields ) {
            _lineno = lineno;
    ...
    class OldAsmReader {
        ...
        public List<OldAsmLine> AsmLines = new List<OldAsmLine>();
        public Dictionary<int, OldAsmLine> AsmLinesByAddress = new Dictionary<int, OldAsmLine>();
        public Dictionary<string, OldAsmLine> AsmLinesByGlobalLabel = new Dictionary<string, OldAsmLine>();
        ...
        public OldAsmReader( string filename ) {
            ...
            while (!parser.EndOfData) {
                ...
                OldAsmLine asmLine = new OldAsmLine( ++lineno, fields );
        ...
        private void ResolveLocalLabels() {
            ...
            int lineno = 0;
            foreach (OldAsmLine asmLine in AsmLines) {
                ++lineno;
